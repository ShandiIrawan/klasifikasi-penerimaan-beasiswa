...
<div class="wrapper">
    ...
    <div class="col sm-10">
    <form action="index.php?page=proses_simpan_mahasiswa" method="POST">
        <div class="form-group">
            <label for="inputNim">Nomor Induk Mahasiswa</label>
            <input type="text" class="form-control" id="inputNim" name="nim" required placeholder="Masukkan nim">
        </div>
        <div class="form-group">
            <label for="inputNama">Nama Mahasiswa</label>
            <input type="text" class="form-control" id="inputNama" name="nama_mahasiswa" required placeholder="Masukkan nama mahasiswa">
        </div>
        <div class="form-group">
            <label for="inputTempatLahir">Tempat Lahir</label>
            <input type="text" class="form-control" id="inputTempatLahir" name="tempat_lahir" required placeholder="Masukkan tempat lahir mahasiswa">
        </div>
        <div class="form-group">
            <label for="inputTtl">Tanggal Lahir</label>
            <input type="date" class="form-control" id="inputTtl" name="ttl" required placeholder="Masukkan tanggal lahir mahasiswa">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="inputIpk" name="ipk" required placeholder="Masukkan ipk">
        </div>
        <div class="form-group">
            ...
            <select class="form-control" name="keikutsertaan" id="inputKeik" required>
              ...
              <option value="Program Wirausaha Mahasiswa">Program Wirausaha Mahasiswa</option>
            </select>
        </div>
        <div class="form-group">
            <label for="inputThnMasuk">Tahun Masuk</label>
            <input type="number" class="form-control" id="inputThnMasuk" name="tahun_masuk" required placeholder="Masukkan tahun masuk">
        </div>
        <div class="form-group">
            <label for="inputBea">Beasiswa Diraih</label>
            <select class="form-control" readonly name="beasiswa" id="inputBea" required>
              <option value="Belum Mendapatkan">Belum Mendapatkan</option>
            </select>
        </div>
